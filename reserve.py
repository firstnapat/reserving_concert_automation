...
# //*[@id="frm-signin"]/div[2]/div/div[1]/input
def Login():
    driver.find_element(By.XPATH, '//*[@class="btn-signin item d-none d-lg-inline-block"]').click()
    sleep(1)
    ...
    while cur_url == base_url:
        driver.find_element(By.PARTIAL_LINK_TEXT, f"{concert}").click()
        driver.implicitly_wait(30)
        cur_url = driver.current_url
    driver.implicitly_wait(30)
...
def SelectShow():
    ...
    selected = driver.find_element(By.XPATH, f'//*[@id="rdId"]/option[1]').text
...
def SelectZone(zone=zone):    
    global zone_list
    list_zone = driver.find_elements(By.XPATH, f'//*[@name="uMap2Map"]/area')
